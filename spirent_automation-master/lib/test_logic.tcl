...
# Generated on Tue Jan 02 13:50:25 2024 by NTtest
...
set Project(1) [stc::create "Project" \
        ...
        -ConfigurationFileName {test.tcl} ]
...
# Set up handles
stc::config $PingVerifyConnectivityCommand(1) -DeviceList "$Port(1) $Port(2) $Port(3) $Port(4) $Port(5) $Port(6)"
...
proc run {} {
    # Subscribe to results for result query test-0001-generatorportresults
    stc::subscribe -parent [lindex [stc::get system1 -children-Project] 0] \
        ...
        -interval 1 -filenamePrefix "test-0001-generatorportresults"

    # Subscribe to results for result query test-0002-analyzerportresults
    stc::subscribe -parent [lindex [stc::get system1 -children-Project] 0] \
        -resultParent " [lindex [stc::get system1 -children-Project] 0] " \
        -configType analyzer \
        ...
        -interval 1 -filenamePrefix "test-0002-analyzerportresults"
