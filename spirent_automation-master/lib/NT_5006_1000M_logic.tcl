...
# Generated on Fri Dec 15 12:20:07 2023 by NTtest
...
set Project(1) [stc::create "Project" \
        ...
        -ConfigurationFileName {NT_5006_1000M.tcl} ]
...
set AnalyzerFrameConfigFilter(1) [stc::create "AnalyzerFrameConfigFilter" \
        -under $Analyzer(1) \
...
set HighResolutionStreamBlockOptions(1) [stc::create "HighResolutionStreamBlockOptions" \
        -under $Analyzer(1) ]
...
set StreamBlock(1) [stc::create "StreamBlock" \
        ...
        -FrameConfig {<frame><config><pdus><pdu name="ethernet_20461" pdu="ethernet:EthernetII"><preamble minByteLength="4" >55555555555555d5</preamble><dstMac>00:10:94:00:00:02</dstMac><srcMac>00:10:94:00:00:01</srcMac></pdu></pdus></config></frame>} \
        -Name {StreamBlock 126-1-1} ]
...
set StreamBlock(2) [stc::create "StreamBlock" \
        ...
        -FixedFrameLength "64" \
        -Filter {Device,MPLS-TP,Bfd,Rip,Lldp,Ieee1588v2,Bgp,Isis,Ldp,Stp,Ospfv3,Lacp,Pim,Rsvp,Ospfv2,FCoE,FCPlugin,FCoEVFPort,FCFPort,TwampClient,TwampServer,LspPing,Lisp,Ancp,PppProtocol,PppoeProtocol,802.1x,Vepa,Packet Channel,SyncE,Dhcpv4,Dhcpv6,Cifs,Dpg,Http,Sip,Ftp,Video,XMPPvJ,RawTcp,CSMP,EthernetII} \
        -FrameConfig {<frame><config><pdus><pdu name="ethernet_20461" pdu="ethernet:EthernetII"><preamble minByteLength="4" >55555555555555d5</preamble><dstMac>00:10:94:00:00:03</dstMac><srcMac>00:10:94:00:00:02</srcMac></pdu></pdus></config></frame>} \
        -Name {StreamBlock 126-2-1} ]
...
set PerspectiveNode(1) [stc::create "PerspectiveNode" \
        ...
        -ContentData {<ContentData><NodeContentData FrameName="frame://l2l3/TxStreamResults/ResultQuery:(1, 0, 1)" ResultDataSetId="Stream Results\Detailed Stream Results" Column="1" Row="0" DockPanelNumber="1" /></ContentData>
} ]
...
set StreamBlock(3) [stc::create "StreamBlock" \
        ...
        -FixedFrameLength "64" \
        -Filter {Device,MPLS-TP,Bfd,Rip,Lldp,Ieee1588v2,Bgp,Isis,Ldp,Stp,Ospfv3,Lacp,Pim,Rsvp,Ospfv2,FCoE,FCPlugin,FCoEVFPort,FCFPort,TwampClient,TwampServer,LspPing,Lisp,Ancp,PppProtocol,PppoeProtocol,802.1x,Vepa,Packet Channel,SyncE,Dhcpv4,Dhcpv6,Cifs,Dpg,Http,Sip,Ftp,Video,XMPPvJ,RawTcp,CSMP,EthernetII} \
        -FrameConfig {<frame><config><pdus><pdu name="ethernet_20461" pdu="ethernet:EthernetII"><preamble minByteLength="4" >55555555555555d5</preamble><dstMac>00:10:94:00:00:04</dstMac><srcMac>00:10:94:00:00:03</srcMac></pdu></pdus></config></frame>} \
        -Name {StreamBlock 126-3-1} ]
...
set StreamBlock(4) [stc::create "StreamBlock" \
        ...
        -FixedFrameLength "64" \
        -Filter {Device,MPLS-TP,Bfd,Rip,Lldp,Ieee1588v2,Bgp,Isis,Ldp,Stp,Ospfv3,Lacp,Pim,Rsvp,Ospfv2,FCoE,FCPlugin,FCoEVFPort,FCFPort,TwampClient,TwampServer,LspPing,Lisp,Ancp,PppProtocol,PppoeProtocol,802.1x,Vepa,Packet Channel,SyncE,Dhcpv4,Dhcpv6,Cifs,Dpg,Http,Sip,Ftp,Video,XMPPvJ,RawTcp,CSMP,EthernetII} \
        -FrameConfig {<frame><config><pdus><pdu name="ethernet_20461" pdu="ethernet:EthernetII"><preamble minByteLength="4" >55555555555555d5</preamble><dstMac>00:10:94:00:00:05</dstMac><srcMac>00:10:94:00:00:04</srcMac></pdu></pdus></config></frame>} \
        -Name {StreamBlock 126-4-1} ]
...
set StreamBlock(5) [stc::create "StreamBlock" \
        ...
        -FixedFrameLength "64" \
        -Filter {Device,MPLS-TP,Bfd,Rip,Lldp,Ieee1588v2,Bgp,Isis,Ldp,Stp,Ospfv3,Lacp,Pim,Rsvp,Ospfv2,FCoE,FCPlugin,FCoEVFPort,FCFPort,TwampClient,TwampServer,LspPing,Lisp,Ancp,PppProtocol,PppoeProtocol,802.1x,Vepa,Packet Channel,SyncE,Dhcpv4,Dhcpv6,Cifs,Dpg,Http,Sip,Ftp,Video,XMPPvJ,RawTcp,CSMP,EthernetII} \
        -FrameConfig {<frame><config><pdus><pdu name="ethernet_20461" pdu="ethernet:EthernetII"><preamble minByteLength="4" >55555555555555d5</preamble><dstMac>00:10:94:00:00:06</dstMac><srcMac>00:10:94:00:00:05</srcMac></pdu></pdus></config></frame>} \
        -Name {StreamBlock 126-5-1} ]
...
set StreamBlock(6) [stc::create "StreamBlock" \
        ...
        -FixedFrameLength "64" \
        -Filter {Device,MPLS-TP,Bfd,Rip,Lldp,Ieee1588v2,Bgp,Isis,Ldp,Stp,Ospfv3,Lacp,Pim,Rsvp,Ospfv2,FCoE,FCPlugin,FCoEVFPort,FCFPort,TwampClient,TwampServer,LspPing,Lisp,Ancp,PppProtocol,PppoeProtocol,802.1x,Vepa,Packet Channel,SyncE,Dhcpv4,Dhcpv6,Cifs,Dpg,Http,Sip,Ftp,Video,XMPPvJ,RawTcp,CSMP,EthernetII} \
        -FrameConfig {<frame><config><pdus><pdu name="ethernet_20461" pdu="ethernet:EthernetII"><preamble minByteLength="4" >55555555555555d5</preamble><dstMac>00:10:94:00:00:01</dstMac><srcMac>00:10:94:00:00:06</srcMac></pdu></pdus></config></frame>} \
        -Name {StreamBlock 126-6-1} ]
...
set ResultDataSet(7) [stc::create "ResultDataSet" \
        -under $Project(1) \
        -PrimaryClass {Port} \
        -CreatorId {VerifyResultsValueCommand} ]

set ResultQuery(9) [stc::create "ResultQuery" \
        -under $ResultDataSet(7) \
        -ConfigClassId "analyzer" \
        -ResultClassId "analyzerportresults" \
        -PropertyIdArray "analyzerportresults.sigframecount" ]
...
set ResultDataSet(8) [stc::create "ResultDataSet" \
        -under $Project(1) \
        -PrimaryClass {Port} \
        -CreatorId {VerifyResultsValueCommand} ]

set ResultQuery(10) [stc::create "ResultQuery" \
        -under $ResultDataSet(8) \
        -ConfigClassId "generator" \
        -ResultClassId "generatorportresults" \
        -PropertyIdArray "generatorportresults.generatorsigframecount" ]

set ResultDataSet(9) [stc::create "ResultDataSet" \
        -under $Project(1) \
        -PrimaryClass {Port} \
        -CreatorId {VerifyResultsValueCommand} ]

set ResultQuery(11) [stc::create "ResultQuery" \
        -under $ResultDataSet(9) \
        -ConfigClassId "analyzer" \
        -ResultClassId "analyzerportresults" \
        -PropertyIdArray "analyzerportresults.sigframecount" ]

set ResultDataSet(10) [stc::create "ResultDataSet" \
        -under $Project(1) \
        -PrimaryClass {Port} \
        -CreatorId {VerifyResultsValueCommand} ]

set ResultQuery(12) [stc::create "ResultQuery" \
        -under $ResultDataSet(10) \
        -ConfigClassId "analyzer" \
        -ResultClassId "analyzerportresults" \
        -PropertyIdArray "analyzerportresults.sigframecount" ]
...
set ColumnDisplayProperties(4) [stc::create "ColumnDisplayProperties" \
        -under $DynamicResultView(1) \
...
set ColumnDisplayProperties(5) [stc::create "ColumnDisplayProperties" \
        -under $DynamicResultView(1) \
...
set ColumnDisplayProperties(6) [stc::create "ColumnDisplayProperties" \
        -under $DynamicResultView(1) \
...
set ColumnDisplayProperties(7) [stc::create "ColumnDisplayProperties" \
        -under $DynamicResultView(1) \
...
set ColumnDisplayProperties(8) [stc::create "ColumnDisplayProperties" \
        -under $DynamicResultView(1) \
...
set ColumnDisplayProperties(9) [stc::create "ColumnDisplayProperties" \
        -under $DynamicResultView(1) \
...
stc::config $StreamBlock(1) -SrcBinding-targets " $EthIIIf(7) "
stc::config $StreamBlock(1) -DstBinding-targets " $EthIIIf(8) "
...
stc::config $StreamBlock(2) -SrcBinding-targets " $EthIIIf(8) "
stc::config $StreamBlock(2) -DstBinding-targets " $EthIIIf(9) "
...
stc::config $PerspectiveNode(1) -PerspectiveChild-targets " $ResultDataSet(2) "
stc::config $PerspectiveNode(2) -PerspectiveChild-targets " $ResultDataSet(2) "
...
stc::config $StreamBlock(3) -SrcBinding-targets " $EthIIIf(9) "
stc::config $StreamBlock(3) -DstBinding-targets " $EthIIIf(10) "
...
stc::config $StreamBlock(4) -SrcBinding-targets " $EthIIIf(10) "
stc::config $StreamBlock(4) -DstBinding-targets " $EthIIIf(11) "
...
stc::config $StreamBlock(5) -SrcBinding-targets " $EthIIIf(11) "
stc::config $StreamBlock(5) -DstBinding-targets " $EthIIIf(12) "
...
stc::config $StreamBlock(6) -SrcBinding-targets " $EthIIIf(12) "
stc::config $StreamBlock(6) -DstBinding-targets " $EthIIIf(7) "
...
stc::config $EmulatedDeviceGenParams(1) -SelectedPort-targets " $Port(1) $Port(2) $Port(3) $Port(4) $Port(5) $Port(6) "
...
stc::config $EmulatedDevice(1) -TopLevelIf-targets " $Ipv4If(7) "
stc::config $EmulatedDevice(1) -PrimaryIf-targets " $Ipv4If(7) "
stc::config $Ipv4If(7) -StackedOnEndpoint-targets " $EthIIIf(7) "
stc::config $EmulatedDevice(2) -TopLevelIf-targets " $Ipv4If(8) "
stc::config $EmulatedDevice(2) -PrimaryIf-targets " $Ipv4If(8) "
stc::config $Ipv4If(8) -StackedOnEndpoint-targets " $EthIIIf(8) "
stc::config $EmulatedDevice(3) -TopLevelIf-targets " $Ipv4If(9) "
stc::config $EmulatedDevice(3) -PrimaryIf-targets " $Ipv4If(9) "
stc::config $Ipv4If(9) -StackedOnEndpoint-targets " $EthIIIf(9) "
stc::config $EmulatedDevice(4) -TopLevelIf-targets " $Ipv4If(10) "
stc::config $EmulatedDevice(4) -PrimaryIf-targets " $Ipv4If(10) "
stc::config $Ipv4If(10) -StackedOnEndpoint-targets " $EthIIIf(10) "
stc::config $EmulatedDevice(5) -TopLevelIf-targets " $Ipv4If(11) "
stc::config $EmulatedDevice(5) -PrimaryIf-targets " $Ipv4If(11) "
stc::config $Ipv4If(11) -StackedOnEndpoint-targets " $EthIIIf(11) "
stc::config $EmulatedDevice(6) -TopLevelIf-targets " $Ipv4If(12) "
stc::config $EmulatedDevice(6) -PrimaryIf-targets " $Ipv4If(12) "
...
stc::config $ResultQuery(6) -ResultRootList "$Port(1) $Port(2)"
...
stc::config $ResultQuery(12) -ResultRootList "$Project(1)"
stc::config $ResultQuery(12) -PropertyHandleArray ""
stc::config $ResultQuery(11) -ResultRootList "$Project(1)"
stc::config $ResultQuery(11) -PropertyHandleArray ""
stc::config $PresentationResultQuery(1) -FromObjects "$Project(1)"
stc::config $ResultQuery(10) -ResultRootList "$Project(1)"
stc::config $ResultQuery(10) -PropertyHandleArray ""
stc::config $SequencerIfCommand(1) -CommandList ""
stc::config $L2LearningStartCommand(1) -HandleList "$Port(1) $Port(2) $Port(3) $Port(4) $Port(5) $Port(6)"
stc::config $GeneratorStartCommand(1) -GeneratorList "$Generator(1) $Generator(2) $Generator(3) $Generator(4) $Generator(5) $Generator(6)"
...
stc::config $GeneratorWaitForStopCommand(1) -GeneratorList "$Generator(1) $Generator(2) $Generator(3) $Generator(4) $Generator(5) $Generator(6)"
stc::config $VerifyResultsValueCondition(1) -ResultQuery "$ResultQuery(12)"
stc::config $ResultQuery(8) -ResultRootList "$Project(1)"
stc::config $ResultQuery(8) -PropertyHandleArray ""
stc::config $ResultQuery(9) -ResultRootList "$Project(1)"
stc::config $ResultQuery(9) -PropertyHandleArray ""
...
proc run {} {
    # Subscribe to results for result query NT_5006_1000M-0001-rxstreamsummaryresults
    stc::subscribe -parent [lindex [stc::get system1 -children-Project] 0] \
        ...
        -interval 1 -filenamePrefix "NT_5006_1000M-0001-rxstreamsummaryresults"

    # Subscribe to results for result query NT_5006_1000M-0002-txstreamresults
    stc::subscribe -parent [lindex [stc::get system1 -children-Project] 0] \
        -resultParent " [lindex [stc::get system1 -children-Project] 0] " \
        -configType streamblock \
        ...
        -interval 1 -filenamePrefix "NT_5006_1000M-0002-txstreamresults"
