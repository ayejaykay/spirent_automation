...
set Project(1) [stc::create "Project" \
        ...
        -ConfigurationFileName {verify_link.tcl} ]
...
# Set up handles
stc::config $PhyVerifyLinkUpCommand(1) -PortList "$Port(1) $Port(2) $Port(3) $Port(4) $Port(5) $Port(6) $Port(7) $Port(8)"
