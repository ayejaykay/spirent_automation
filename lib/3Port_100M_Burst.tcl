...
# Generated on Tue Apr 16 10:09:56 2024 by NTtest
...
# 3Port_100M_Burst_logic.tcl script. After sourcing the logic script,
...
source [ file normalize [ file join [ file dirname [ info script ] ] {3Port_100M_Burst_logic.tcl} ] ]


init [ file normalize [ file join [ file dirname [ info script ] ] {3Port_100M_Burst_log.tcl} ] ]
#config [list "//10.11.1.3/3/1" "//10.11.1.3/3/2" "//10.11.1.3/3/3" ]
