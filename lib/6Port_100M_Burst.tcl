...
# 6Port_100M_Burst_logic.tcl script. After sourcing the logic script,
...
source [ file normalize [ file join [ file dirname [ info script ] ] {6Port_100M_Burst_logic.tcl} ] ]


init [ file normalize [ file join [ file dirname [ info script ] ] {6Port_100M_Burst_log.tcl} ] ]
