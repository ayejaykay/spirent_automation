...
# Generated on Tue Jan 02 14:32:23 2024 by NTtest
...
set Project(1) [stc::create "Project" \
        ...
        -ConfigurationFileName {teseter.tcl} ]
...
set SequencerLoopCommand(1) [stc::create "SequencerLoopCommand" \
        -under $Sequencer(1) \
        -IterationCount "10" ]

set PhyVerifyLinkUpCommand(1) [stc::create "PhyVerifyLinkUpCommand" \
        -under $SequencerLoopCommand(1) \
        -ErrorOnFailure "TRUE" ]
...
# Set up handles
stc::config $Sequencer(1) -CommandList "$SequencerLoopCommand(1)"
...
stc::config $PhyVerifyLinkUpCommand(1) -PortList "$Port(1) $Port(2) $Port(3) $Port(4) $Port(5) $Port(6)"
stc::config $SequencerLoopCommand(1) -CommandList "$PhyVerifyLinkUpCommand(1)"
...
proc run {} {
    # Subscribe to results for result query teseter-0001-generatorportresults
    stc::subscribe -parent [lindex [stc::get system1 -children-Project] 0] \
        ...
        -interval 1 -filenamePrefix "teseter-0001-generatorportresults"

    # Subscribe to results for result query teseter-0002-analyzerportresults
    stc::subscribe -parent [lindex [stc::get system1 -children-Project] 0] \
        -resultParent " [lindex [stc::get system1 -children-Project] 0] " \
        -configType analyzer \
        ...
        -interval 1 -filenamePrefix "teseter-0002-analyzerportresults"
