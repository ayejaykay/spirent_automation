...
# Generated on Tue Apr 16 09:58:37 2024 by NTtest
...
set Project(1) [stc::create "Project" \
        ...
        -ConfigurationFileName {2Port_100M_Burst.tcl} ]
...
set StreamBlock(1) [stc::create "StreamBlock" \
        ...
        -FrameConfig {<frame><config><pdus><pdu name="ethernet_12205" pdu="ethernet:EthernetII"><preamble minByteLength="4" >55555555555555d5</preamble><dstMac>00:10:94:00:00:02</dstMac><srcMac>00:10:94:00:00:01</srcMac></pdu></pdus></config></frame>} \
        -Name {StreamBlock 69-1-1} ]
...
set StreamBlock(2) [stc::create "StreamBlock" \
        ...
        -FixedFrameLength "64" \
        -Filter {Device,MPLS-TP,Bfd,Rip,Lldp,Ieee1588v2,Bgp,Isis,Ldp,Stp,Ospfv3,Lacp,Pim,Rsvp,Ospfv2,FCoE,FCPlugin,FCoEVFPort,FCFPort,TwampClient,TwampServer,LspPing,Lisp,Ancp,PppProtocol,PppoeProtocol,802.1x,Vepa,Packet Channel,SyncE,Dhcpv4,Dhcpv6,Cifs,Dpg,Http,Sip,Ftp,Video,XMPPvJ,RawTcp,CSMP,EthernetII} \
        -FrameConfig {<frame><config><pdus><pdu name="ethernet_12205" pdu="ethernet:EthernetII"><preamble minByteLength="4" >55555555555555d5</preamble><dstMac>00:10:94:00:00:01</dstMac><srcMac>00:10:94:00:00:02</srcMac></pdu></pdus></config></frame>} \
        -Name {StreamBlock 69-2-1} ]
...
stc::config $StreamBlock(1) -SrcBinding-targets " $EthIIIf(3) "
stc::config $StreamBlock(1) -DstBinding-targets " $EthIIIf(4) "
...
stc::config $StreamBlock(2) -SrcBinding-targets " $EthIIIf(4) "
stc::config $StreamBlock(2) -DstBinding-targets " $EthIIIf(3) "
...
stc::config $EmulatedDeviceGenParams(1) -SelectedPort-targets " $Port(1) $Port(2) "
...
stc::config $EmulatedDevice(1) -TopLevelIf-targets " $Ipv4If(3) "
stc::config $EmulatedDevice(1) -PrimaryIf-targets " $Ipv4If(3) "
stc::config $Ipv4If(3) -StackedOnEndpoint-targets " $EthIIIf(3) "
stc::config $EmulatedDevice(2) -TopLevelIf-targets " $Ipv4If(4) "
stc::config $EmulatedDevice(2) -PrimaryIf-targets " $Ipv4If(4) "
...
stc::config $L2LearningStartCommand(1) -HandleList "$Port(1) $Port(2)"
stc::config $GeneratorWaitForStopCommand(1) -GeneratorList "$Generator(1) $Generator(2)"
...
stc::config $GeneratorStartCommand(1) -GeneratorList "$Generator(1) $Generator(2)"
stc::config $VerifyResultsValueCondition(1) -ResultQuery "$ResultQuery(10)"
