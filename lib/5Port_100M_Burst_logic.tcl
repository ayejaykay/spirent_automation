...
# Generated on Tue Apr 16 10:34:02 2024 by NTtest
...
set Project(1) [stc::create "Project" \
        ...
        -ConfigurationFileName {5Port_100M_Burst.tcl} ]
...
set StreamBlock(1) [stc::create "StreamBlock" \
        ...
        -FrameConfig {<frame><config><pdus><pdu name="ethernet_10159" pdu="ethernet:EthernetII"><preamble minByteLength="4" >55555555555555d5</preamble><dstMac>00:10:94:00:00:02</dstMac><srcMac>00:10:94:00:00:01</srcMac></pdu></pdus></config></frame>} \
        -Name {StreamBlock 46-1-1} ]
...
set StreamBlock(2) [stc::create "StreamBlock" \
        ...
        -FixedFrameLength "64" \
        -Filter {Device,MPLS-TP,Bfd,Rip,Lldp,Ieee1588v2,Bgp,Isis,Ldp,Stp,Ospfv3,Lacp,Pim,Rsvp,Ospfv2,FCoE,FCPlugin,FCoEVFPort,FCFPort,TwampClient,TwampServer,LspPing,Lisp,Ancp,PppProtocol,PppoeProtocol,802.1x,Vepa,Packet Channel,SyncE,Dhcpv4,Dhcpv6,Cifs,Dpg,Http,Sip,Ftp,Video,XMPPvJ,RawTcp,CSMP,EthernetII} \
        -FrameConfig {<frame><config><pdus><pdu name="ethernet_10159" pdu="ethernet:EthernetII"><preamble minByteLength="4" >55555555555555d5</preamble><dstMac>00:10:94:00:00:03</dstMac><srcMac>00:10:94:00:00:02</srcMac></pdu></pdus></config></frame>} \
        -Name {StreamBlock 46-2-1} ]
...
set StreamBlock(3) [stc::create "StreamBlock" \
        ...
        -FixedFrameLength "64" \
        -Filter {Device,MPLS-TP,Bfd,Rip,Lldp,Ieee1588v2,Bgp,Isis,Ldp,Stp,Ospfv3,Lacp,Pim,Rsvp,Ospfv2,FCoE,FCPlugin,FCoEVFPort,FCFPort,TwampClient,TwampServer,LspPing,Lisp,Ancp,PppProtocol,PppoeProtocol,802.1x,Vepa,Packet Channel,SyncE,Dhcpv4,Dhcpv6,Cifs,Dpg,Http,Sip,Ftp,Video,XMPPvJ,RawTcp,CSMP,EthernetII} \
        -FrameConfig {<frame><config><pdus><pdu name="ethernet_10159" pdu="ethernet:EthernetII"><preamble minByteLength="4" >55555555555555d5</preamble><dstMac>00:10:94:00:00:04</dstMac><srcMac>00:10:94:00:00:03</srcMac></pdu></pdus></config></frame>} \
        -Name {StreamBlock 46-3-1} ]
...
set StreamBlock(4) [stc::create "StreamBlock" \
        ...
        -FixedFrameLength "64" \
        -Filter {Device,MPLS-TP,Bfd,Rip,Lldp,Ieee1588v2,Bgp,Isis,Ldp,Stp,Ospfv3,Lacp,Pim,Rsvp,Ospfv2,FCoE,FCPlugin,FCoEVFPort,FCFPort,TwampClient,TwampServer,LspPing,Lisp,Ancp,PppProtocol,PppoeProtocol,802.1x,Vepa,Packet Channel,SyncE,Dhcpv4,Dhcpv6,Cifs,Dpg,Http,Sip,Ftp,Video,XMPPvJ,RawTcp,CSMP,EthernetII} \
        -FrameConfig {<frame><config><pdus><pdu name="ethernet_10159" pdu="ethernet:EthernetII"><preamble minByteLength="4" >55555555555555d5</preamble><dstMac>00:10:94:00:00:05</dstMac><srcMac>00:10:94:00:00:04</srcMac></pdu></pdus></config></frame>} \
        -Name {StreamBlock 46-4-1} ]
...
set StreamBlock(5) [stc::create "StreamBlock" \
        ...
        -FixedFrameLength "64" \
        -Filter {Device,MPLS-TP,Bfd,Rip,Lldp,Ieee1588v2,Bgp,Isis,Ldp,Stp,Ospfv3,Lacp,Pim,Rsvp,Ospfv2,FCoE,FCPlugin,FCoEVFPort,FCFPort,TwampClient,TwampServer,LspPing,Lisp,Ancp,PppProtocol,PppoeProtocol,802.1x,Vepa,Packet Channel,SyncE,Dhcpv4,Dhcpv6,Cifs,Dpg,Http,Sip,Ftp,Video,XMPPvJ,RawTcp,CSMP,EthernetII} \
        -FrameConfig {<frame><config><pdus><pdu name="ethernet_10159" pdu="ethernet:EthernetII"><preamble minByteLength="4" >55555555555555d5</preamble><dstMac>00:10:94:00:00:01</dstMac><srcMac>00:10:94:00:00:05</srcMac></pdu></pdus></config></frame>} \
        -Name {StreamBlock 46-5-1} ]
...
set PerspectiveNode(2) [stc::create "PerspectiveNode" \
        ...
        -Data {<NodeData Name="resultFrame.2" FrameId="1F412EE6-760C-4937-9644-ACFA463EA44E" Active="true" RowCount="1" ColumnCount="2" />} \
        -ContentData {<ContentData />
...
stc::config $StreamBlock(1) -SrcBinding-targets " $EthIIIf(6) "
stc::config $StreamBlock(1) -DstBinding-targets " $EthIIIf(7) "
...
stc::config $StreamBlock(2) -SrcBinding-targets " $EthIIIf(7) "
stc::config $StreamBlock(2) -DstBinding-targets " $EthIIIf(8) "
...
stc::config $StreamBlock(3) -SrcBinding-targets " $EthIIIf(8) "
stc::config $StreamBlock(3) -DstBinding-targets " $EthIIIf(9) "
...
stc::config $StreamBlock(4) -SrcBinding-targets " $EthIIIf(9) "
stc::config $StreamBlock(4) -DstBinding-targets " $EthIIIf(10) "
...
stc::config $StreamBlock(5) -SrcBinding-targets " $EthIIIf(10) "
stc::config $StreamBlock(5) -DstBinding-targets " $EthIIIf(6) "
...
stc::config $EmulatedDeviceGenParams(1) -SelectedPort-targets " $Port(1) $Port(2) $Port(3) $Port(4) $Port(5) "
...
stc::config $EmulatedDevice(1) -TopLevelIf-targets " $Ipv4If(6) "
stc::config $EmulatedDevice(1) -PrimaryIf-targets " $Ipv4If(6) "
stc::config $Ipv4If(6) -StackedOnEndpoint-targets " $EthIIIf(6) "
stc::config $EmulatedDevice(2) -TopLevelIf-targets " $Ipv4If(7) "
stc::config $EmulatedDevice(2) -PrimaryIf-targets " $Ipv4If(7) "
stc::config $Ipv4If(7) -StackedOnEndpoint-targets " $EthIIIf(7) "
stc::config $EmulatedDevice(3) -TopLevelIf-targets " $Ipv4If(8) "
stc::config $EmulatedDevice(3) -PrimaryIf-targets " $Ipv4If(8) "
stc::config $Ipv4If(8) -StackedOnEndpoint-targets " $EthIIIf(8) "
stc::config $EmulatedDevice(4) -TopLevelIf-targets " $Ipv4If(9) "
stc::config $EmulatedDevice(4) -PrimaryIf-targets " $Ipv4If(9) "
stc::config $Ipv4If(9) -StackedOnEndpoint-targets " $EthIIIf(9) "
stc::config $EmulatedDevice(5) -TopLevelIf-targets " $Ipv4If(10) "
stc::config $EmulatedDevice(5) -PrimaryIf-targets " $Ipv4If(10) "
...
stc::config $L2LearningStartCommand(1) -HandleList "$Port(1) $Port(2) $Port(3) $Port(4) $Port(5)"
...
stc::config $GeneratorWaitForStopCommand(1) -GeneratorList "$Generator(1) $Generator(2) $Generator(3) $Generator(4) $Generator(5)"
...
stc::config $GeneratorStartCommand(1) -GeneratorList "$Generator(1) $Generator(2) $Generator(3) $Generator(4) $Generator(5)"
stc::config $VerifyResultsValueCondition(1) -ResultQuery "$ResultQuery(7)"
