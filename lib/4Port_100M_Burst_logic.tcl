...
# Generated on Tue Apr 16 10:14:16 2024 by NTtest
...
set Project(1) [stc::create "Project" \
        ...
        -ConfigurationFileName {4Port_100M_Burst.tcl} ]
...
set StreamBlock(1) [stc::create "StreamBlock" \
        ...
        -FrameConfig {<frame><config><pdus><pdu name="ethernet_16977" pdu="ethernet:EthernetII"><preamble minByteLength="4" >55555555555555d5</preamble><dstMac>00:10:94:00:00:02</dstMac><srcMac>00:10:94:00:00:01</srcMac></pdu></pdus></config></frame>} \
        -Name {StreamBlock 97-1-1} ]
...
set StreamBlock(2) [stc::create "StreamBlock" \
        ...
        -FixedFrameLength "64" \
        -Filter {Device,MPLS-TP,Bfd,Rip,Lldp,Ieee1588v2,Bgp,Isis,Ldp,Stp,Ospfv3,Lacp,Pim,Rsvp,Ospfv2,FCoE,FCPlugin,FCoEVFPort,FCFPort,TwampClient,TwampServer,LspPing,Lisp,Ancp,PppProtocol,PppoeProtocol,802.1x,Vepa,Packet Channel,SyncE,Dhcpv4,Dhcpv6,Cifs,Dpg,Http,Sip,Ftp,Video,XMPPvJ,RawTcp,CSMP,EthernetII} \
        -FrameConfig {<frame><config><pdus><pdu name="ethernet_16977" pdu="ethernet:EthernetII"><preamble minByteLength="4" >55555555555555d5</preamble><dstMac>00:10:94:00:00:03</dstMac><srcMac>00:10:94:00:00:02</srcMac></pdu></pdus></config></frame>} \
        -Name {StreamBlock 97-2-1} ]
...
set StreamBlock(3) [stc::create "StreamBlock" \
        ...
        -FixedFrameLength "64" \
        -Filter {Device,MPLS-TP,Bfd,Rip,Lldp,Ieee1588v2,Bgp,Isis,Ldp,Stp,Ospfv3,Lacp,Pim,Rsvp,Ospfv2,FCoE,FCPlugin,FCoEVFPort,FCFPort,TwampClient,TwampServer,LspPing,Lisp,Ancp,PppProtocol,PppoeProtocol,802.1x,Vepa,Packet Channel,SyncE,Dhcpv4,Dhcpv6,Cifs,Dpg,Http,Sip,Ftp,Video,XMPPvJ,RawTcp,CSMP,EthernetII} \
        -FrameConfig {<frame><config><pdus><pdu name="ethernet_16977" pdu="ethernet:EthernetII"><preamble minByteLength="4" >55555555555555d5</preamble><dstMac>00:10:94:00:00:04</dstMac><srcMac>00:10:94:00:00:03</srcMac></pdu></pdus></config></frame>} \
        -Name {StreamBlock 97-3-1} ]
...
set StreamBlock(4) [stc::create "StreamBlock" \
        ...
        -FixedFrameLength "64" \
        -Filter {Device,MPLS-TP,Bfd,Rip,Lldp,Ieee1588v2,Bgp,Isis,Ldp,Stp,Ospfv3,Lacp,Pim,Rsvp,Ospfv2,FCoE,FCPlugin,FCoEVFPort,FCFPort,TwampClient,TwampServer,LspPing,Lisp,Ancp,PppProtocol,PppoeProtocol,802.1x,Vepa,Packet Channel,SyncE,Dhcpv4,Dhcpv6,Cifs,Dpg,Http,Sip,Ftp,Video,XMPPvJ,RawTcp,CSMP,EthernetII} \
        -FrameConfig {<frame><config><pdus><pdu name="ethernet_16977" pdu="ethernet:EthernetII"><preamble minByteLength="4" >55555555555555d5</preamble><dstMac>00:10:94:00:00:01</dstMac><srcMac>00:10:94:00:00:04</srcMac></pdu></pdus></config></frame>} \
        -Name {StreamBlock 97-4-1} ]
...
set ResultQuery(4) [stc::create "ResultQuery" \
        ...
        -PropertyIdArray "txbasicresults.framecount txbasicresults.framerate txbasicresults.bitrate txstreamresults.expectedrxframecount txbasicresults.l1bitcount txbasicresults.l1bitrate txbasicresults.bitcount" \
        -ResultOptions {Basic} ]
...
set PerspectiveNode(1) [stc::create "PerspectiveNode" \
        ...
        -ContentData {<ContentData><NodeContentData FrameName="frame://core/Port/ResultQuery:(1, 0, 0)" ResultDataSetId="Port Traffic\Basic Traffic Results" Column="0" Row="0" DockPanelNumber="1" /></ContentData>
...
stc::config $StreamBlock(1) -SrcBinding-targets " $EthIIIf(5) "
stc::config $StreamBlock(1) -DstBinding-targets " $EthIIIf(6) "
...
stc::config $StreamBlock(2) -SrcBinding-targets " $EthIIIf(6) "
stc::config $StreamBlock(2) -DstBinding-targets " $EthIIIf(7) "
...
stc::config $StreamBlock(3) -SrcBinding-targets " $EthIIIf(7) "
stc::config $StreamBlock(3) -DstBinding-targets " $EthIIIf(8) "
...
stc::config $StreamBlock(4) -SrcBinding-targets " $EthIIIf(8) "
stc::config $StreamBlock(4) -DstBinding-targets " $EthIIIf(5) "
...
stc::config $EmulatedDeviceGenParams(1) -SelectedPort-targets " $Port(1) $Port(2) $Port(3) $Port(4) "
...
stc::config $EmulatedDevice(1) -TopLevelIf-targets " $Ipv4If(5) "
stc::config $EmulatedDevice(1) -PrimaryIf-targets " $Ipv4If(5) "
stc::config $Ipv4If(5) -StackedOnEndpoint-targets " $EthIIIf(5) "
stc::config $EmulatedDevice(2) -TopLevelIf-targets " $Ipv4If(6) "
stc::config $EmulatedDevice(2) -PrimaryIf-targets " $Ipv4If(6) "
stc::config $Ipv4If(6) -StackedOnEndpoint-targets " $EthIIIf(6) "
stc::config $EmulatedDevice(3) -TopLevelIf-targets " $Ipv4If(7) "
stc::config $EmulatedDevice(3) -PrimaryIf-targets " $Ipv4If(7) "
stc::config $Ipv4If(7) -StackedOnEndpoint-targets " $EthIIIf(7) "
stc::config $EmulatedDevice(4) -TopLevelIf-targets " $Ipv4If(8) "
stc::config $EmulatedDevice(4) -PrimaryIf-targets " $Ipv4If(8) "
...
stc::config $PerspectiveNode(1) -PerspectiveChild-targets " $ResultDataSet(1) "
stc::config $PerspectiveNode(2) -PerspectiveChild-targets " $ResultDataSet(1) "
...
stc::config $L2LearningStartCommand(1) -HandleList "$Port(1) $Port(2) $Port(3) $Port(4)"
stc::config $GeneratorStartCommand(1) -GeneratorList "$Generator(1) $Generator(2) $Generator(3) $Generator(4)"
stc::config $ResultsClearAllCommand(1) -PortList "$Project(1)"
stc::config $GeneratorWaitForStopCommand(1) -GeneratorList "$Generator(1) $Generator(2) $Generator(3) $Generator(4)"
