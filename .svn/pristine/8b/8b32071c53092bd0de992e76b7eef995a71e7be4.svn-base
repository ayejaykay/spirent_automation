...
class RedlionSQL:
    ...
    def serial_is_programed(self, serial):
        return self.select_param_equal('Programming', 'Serial', serial).fetchval()
    ...
    def serial_is_spirent_tested(self, serial):
        return self.select_param_equal('Spirent', 'Serial', serial).fetchval()
    ...
    def write_test_result_to_db(self, test, serial, result):
        self.update(test, result, 'Serial', serial)
