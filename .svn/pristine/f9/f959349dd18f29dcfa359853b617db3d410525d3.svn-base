...
# Generated on Tue Apr 16 13:45:36 2024 by NTtest
...
set Project(1) [stc::create "Project" \
        ...
        -ConfigurationFileName {8Port_100M_Burst.tcl} ]
...
stc::config $DeviceAddrOptions(1) \
        -NextIpv4 "192.85.14.3" \
        -NextMac "00:10:94:00:00:0f" \
        -NextRouterId "192.0.13.1"
...
set StreamBlock(1) [stc::create "StreamBlock" \
        ...
        -FrameConfig {<frame><config><pdus><pdu name="ethernet_7956" pdu="ethernet:EthernetII"><preamble minByteLength="4" >55555555555555d5</preamble><dstMac>00:10:94:00:00:02</dstMac><srcMac>00:10:94:00:00:01</srcMac></pdu></pdus></config></frame>} \
        -Name {StreamBlock 17-1-1} ]
...
set StreamBlock(2) [stc::create "StreamBlock" \
        ...
        -FixedFrameLength "64" \
        -Filter {Device,MPLS-TP,Bfd,Rip,Lldp,Ieee1588v2,Bgp,Isis,Ldp,Stp,Ospfv3,Lacp,Pim,Rsvp,Ospfv2,FCoE,FCPlugin,FCoEVFPort,FCFPort,TwampClient,TwampServer,LspPing,Lisp,Ancp,PppProtocol,PppoeProtocol,802.1x,Vepa,Packet Channel,SyncE,Dhcpv4,Dhcpv6,Cifs,Dpg,Http,Sip,Ftp,Video,XMPPvJ,RawTcp,CSMP,EthernetII} \
        -FrameConfig {<frame><config><pdus><pdu name="ethernet_7956" pdu="ethernet:EthernetII"><preamble minByteLength="4" >55555555555555d5</preamble><dstMac>00:10:94:00:00:03</dstMac><srcMac>00:10:94:00:00:02</srcMac></pdu></pdus></config></frame>} \
        -Name {StreamBlock 17-2-1} ]
...
set StreamBlock(3) [stc::create "StreamBlock" \
        ...
        -FixedFrameLength "64" \
        -Filter {Device,MPLS-TP,Bfd,Rip,Lldp,Ieee1588v2,Bgp,Isis,Ldp,Stp,Ospfv3,Lacp,Pim,Rsvp,Ospfv2,FCoE,FCPlugin,FCoEVFPort,FCFPort,TwampClient,TwampServer,LspPing,Lisp,Ancp,PppProtocol,PppoeProtocol,802.1x,Vepa,Packet Channel,SyncE,Dhcpv4,Dhcpv6,Cifs,Dpg,Http,Sip,Ftp,Video,XMPPvJ,RawTcp,CSMP,EthernetII} \
        -FrameConfig {<frame><config><pdus><pdu name="ethernet_7956" pdu="ethernet:EthernetII"><preamble minByteLength="4" >55555555555555d5</preamble><dstMac>00:10:94:00:00:04</dstMac><srcMac>00:10:94:00:00:03</srcMac></pdu></pdus></config></frame>} \
        -Name {StreamBlock 17-3-1} ]
...
stc::config $AnalyzerConfig(4) \
        -Name {Advanced Settings 8}
...
set StreamBlock(4) [stc::create "StreamBlock" \
        ...
        -FixedFrameLength "64" \
        -Filter {Device,MPLS-TP,Bfd,Rip,Lldp,Ieee1588v2,Bgp,Isis,Ldp,Stp,Ospfv3,Lacp,Pim,Rsvp,Ospfv2,FCoE,FCPlugin,FCoEVFPort,FCFPort,TwampClient,TwampServer,LspPing,Lisp,Ancp,PppProtocol,PppoeProtocol,802.1x,Vepa,Packet Channel,SyncE,Dhcpv4,Dhcpv6,Cifs,Dpg,Http,Sip,Ftp,Video,XMPPvJ,RawTcp,CSMP,EthernetII} \
        -FrameConfig {<frame><config><pdus><pdu name="ethernet_7956" pdu="ethernet:EthernetII"><preamble minByteLength="4" >55555555555555d5</preamble><dstMac>00:10:94:00:00:05</dstMac><srcMac>00:10:94:00:00:04</srcMac></pdu></pdus></config></frame>} \
        -Name {StreamBlock 17-4-1} ]
...
stc::config $AnalyzerConfig(5) \
        -Name {Advanced Settings 9}
...
set StreamBlock(5) [stc::create "StreamBlock" \
        ...
        -FixedFrameLength "64" \
        -Filter {Device,MPLS-TP,Bfd,Rip,Lldp,Ieee1588v2,Bgp,Isis,Ldp,Stp,Ospfv3,Lacp,Pim,Rsvp,Ospfv2,FCoE,FCPlugin,FCoEVFPort,FCFPort,TwampClient,TwampServer,LspPing,Lisp,Ancp,PppProtocol,PppoeProtocol,802.1x,Vepa,Packet Channel,SyncE,Dhcpv4,Dhcpv6,Cifs,Dpg,Http,Sip,Ftp,Video,XMPPvJ,RawTcp,CSMP,EthernetII} \
        -FrameConfig {<frame><config><pdus><pdu name="ethernet_7956" pdu="ethernet:EthernetII"><preamble minByteLength="4" >55555555555555d5</preamble><dstMac>00:10:94:00:00:06</dstMac><srcMac>00:10:94:00:00:05</srcMac></pdu></pdus></config></frame>} \
        -Name {StreamBlock 17-5-1} ]
...
stc::config $AnalyzerConfig(6) \
        -Name {Advanced Settings 10}
...
set StreamBlock(6) [stc::create "StreamBlock" \
        ...
        -FixedFrameLength "64" \
        -Filter {Device,MPLS-TP,Bfd,Rip,Lldp,Ieee1588v2,Bgp,Isis,Ldp,Stp,Ospfv3,Lacp,Pim,Rsvp,Ospfv2,FCoE,FCPlugin,FCoEVFPort,FCFPort,TwampClient,TwampServer,LspPing,Lisp,Ancp,PppProtocol,PppoeProtocol,802.1x,Vepa,Packet Channel,SyncE,Dhcpv4,Dhcpv6,Cifs,Dpg,Http,Sip,Ftp,Video,XMPPvJ,RawTcp,CSMP,EthernetII} \
        -FrameConfig {<frame><config><pdus><pdu name="ethernet_7956" pdu="ethernet:EthernetII"><preamble minByteLength="4" >55555555555555d5</preamble><dstMac>00:10:94:00:00:07</dstMac><srcMac>00:10:94:00:00:06</srcMac></pdu></pdus></config></frame>} \
        -Name {StreamBlock 17-6-1} ]
...
stc::config $AnalyzerConfig(7) \
        -Name {Advanced Settings 11}
...
set StreamBlock(7) [stc::create "StreamBlock" \
        ...
        -FixedFrameLength "64" \
        -Filter {Device,MPLS-TP,Bfd,Rip,Lldp,Ieee1588v2,Bgp,Isis,Ldp,Stp,Ospfv3,Lacp,Pim,Rsvp,Ospfv2,FCoE,FCPlugin,FCoEVFPort,FCFPort,TwampClient,TwampServer,LspPing,Lisp,Ancp,PppProtocol,PppoeProtocol,802.1x,Vepa,Packet Channel,SyncE,Dhcpv4,Dhcpv6,Cifs,Dpg,Http,Sip,Ftp,Video,XMPPvJ,RawTcp,CSMP,EthernetII} \
        -FrameConfig {<frame><config><pdus><pdu name="ethernet_7956" pdu="ethernet:EthernetII"><preamble minByteLength="4" >55555555555555d5</preamble><dstMac>00:10:94:00:00:08</dstMac><srcMac>00:10:94:00:00:07</srcMac></pdu></pdus></config></frame>} \
        -Name {StreamBlock 17-7-1} ]
...
stc::config $AnalyzerConfig(8) \
        -Name {Advanced Settings 12}
...
set StreamBlock(8) [stc::create "StreamBlock" \
        ...
        -FixedFrameLength "64" \
        -Filter {Device,MPLS-TP,Bfd,Rip,Lldp,Ieee1588v2,Bgp,Isis,Ldp,Stp,Ospfv3,Lacp,Pim,Rsvp,Ospfv2,FCoE,FCPlugin,FCoEVFPort,FCFPort,TwampClient,TwampServer,LspPing,Lisp,Ancp,PppProtocol,PppoeProtocol,802.1x,Vepa,Packet Channel,SyncE,Dhcpv4,Dhcpv6,Cifs,Dpg,Http,Sip,Ftp,Video,XMPPvJ,RawTcp,CSMP,EthernetII} \
        -FrameConfig {<frame><config><pdus><pdu name="ethernet_7956" pdu="ethernet:EthernetII"><preamble minByteLength="4" >55555555555555d5</preamble><dstMac>00:10:94:00:00:01</dstMac><srcMac>00:10:94:00:00:08</srcMac></pdu></pdus></config></frame>} \
        -Name {StreamBlock 17-8-1} ]
...
set DeviceGenLinkedStep(1) [stc::create "DeviceGenLinkedStep" \
        -under $DeviceGenIpv4IfParams(1) \
        -PropertyId {Addr} \
        -LinkToId {port} \
        -Step {0.0.1.0} ]
...
set Ipv4If(9) [stc::create "Ipv4If" \
...
set EthIIIf(9) [stc::create "EthIIIf" \
        -under $EmulatedDevice(1) \
...
set Ipv4If(10) [stc::create "Ipv4If" \
...
set EthIIIf(10) [stc::create "EthIIIf" \
        -under $EmulatedDevice(2) \
        -SrcMacList "" ]
...
set Ipv4If(11) [stc::create "Ipv4If" \
...
set EthIIIf(11) [stc::create "EthIIIf" \
        -under $EmulatedDevice(3) \
        -SourceMac "00:10:94:00:00:03" \
        -SrcMacList "" ]

set EmulatedDevice(4) [stc::create "EmulatedDevice" \
        -under $Project(1) \
        -RouterId "192.0.8.1" ]

set Ipv4If(12) [stc::create "Ipv4If" \
        -under $EmulatedDevice(4) \
        -Address "192.0.3.1" \
        -AddrList "" \
        -Gateway "192.0.3.1" \
        -GatewayList "" ]

set EthIIIf(12) [stc::create "EthIIIf" \
        -under $EmulatedDevice(4) \
        -SourceMac "00:10:94:00:00:04" \
        -SrcMacList "" ]

set EmulatedDevice(5) [stc::create "EmulatedDevice" \
        -under $Project(1) \
        -RouterId "192.0.9.1" ]

set Ipv4If(13) [stc::create "Ipv4If" \
        -under $EmulatedDevice(5) \
        -Address "192.0.4.1" \
        -AddrList "" \
        -Gateway "192.0.4.1" \
        -GatewayList "" ]

set EthIIIf(13) [stc::create "EthIIIf" \
        -under $EmulatedDevice(5) \
        -SourceMac "00:10:94:00:00:05" \
        -SrcMacList "" ]

set EmulatedDevice(6) [stc::create "EmulatedDevice" \
        -under $Project(1) \
        -RouterId "192.0.10.1" ]

set Ipv4If(14) [stc::create "Ipv4If" \
        -under $EmulatedDevice(6) \
        -Address "192.0.5.1" \
        -AddrList "" \
        -Gateway "192.0.5.1" \
        -GatewayList "" ]

set EthIIIf(14) [stc::create "EthIIIf" \
        -under $EmulatedDevice(6) \
        -SourceMac "00:10:94:00:00:06" \
        -SrcMacList "" ]

set EmulatedDevice(7) [stc::create "EmulatedDevice" \
        -under $Project(1) \
        -RouterId "192.0.11.1" ]

set Ipv4If(15) [stc::create "Ipv4If" \
        -under $EmulatedDevice(7) \
        -Address "192.0.6.1" \
        -AddrList "" \
        -Gateway "192.0.6.1" \
        -GatewayList "" ]

set EthIIIf(15) [stc::create "EthIIIf" \
        -under $EmulatedDevice(7) \
        -SourceMac "00:10:94:00:00:07" \
        -SrcMacList "" ]

set EmulatedDevice(8) [stc::create "EmulatedDevice" \
        -under $Project(1) \
        -RouterId "192.0.12.1" ]

set Ipv4If(16) [stc::create "Ipv4If" \
        -under $EmulatedDevice(8) \
        -Address "192.0.7.1" \
        -AddrList "" \
        -Gateway "192.0.7.1" \
        -GatewayList "" ]

set EthIIIf(16) [stc::create "EthIIIf" \
        -under $EmulatedDevice(8) \
...
set RxPortResultFilter(3) [stc::create "RxPortResultFilter" \
        -under $Project(1) ]
...
set StreamBlockLoadProfile(4) [stc::create "StreamBlockLoadProfile" \
        -under $Project(1) ]

set StreamBlockLoadProfile(5) [stc::create "StreamBlockLoadProfile" \
        -under $Project(1) ]

set StreamBlockLoadProfile(6) [stc::create "StreamBlockLoadProfile" \
        -under $Project(1) ]

set StreamBlockLoadProfile(7) [stc::create "StreamBlockLoadProfile" \
        -under $Project(1) ]

set StreamBlockLoadProfile(8) [stc::create "StreamBlockLoadProfile" \
        -under $Project(1) ]
...
set Sequencer(1) [stc::create "Sequencer" \
        -under $system1 \
        -CurrentSubCommandName {Learning: Start L2 Learning 1} ]
...
stc::config $Port(4) -AffiliationPort-sources " $EmulatedDevice(4) "
stc::config $Port(4) -ActivePhy-targets " $EthernetCopper(4) "
stc::config $Port(5) -AffiliationPort-sources " $EmulatedDevice(5) "
stc::config $Port(5) -ActivePhy-targets " $EthernetCopper(5) "
stc::config $Port(6) -AffiliationPort-sources " $EmulatedDevice(6) "
stc::config $Port(6) -ActivePhy-targets " $EthernetCopper(6) "
stc::config $Port(7) -AffiliationPort-sources " $EmulatedDevice(7) "
stc::config $Port(7) -ActivePhy-targets " $EthernetCopper(7) "
stc::config $Port(8) -AffiliationPort-sources " $EmulatedDevice(8) "
stc::config $Port(8) -ActivePhy-targets " $EthernetCopper(8) "
...
stc::config $StreamBlock(1) -SrcBinding-targets " $EthIIIf(9) "
stc::config $StreamBlock(1) -DstBinding-targets " $EthIIIf(10) "
...
stc::config $StreamBlock(2) -SrcBinding-targets " $EthIIIf(10) "
stc::config $StreamBlock(2) -DstBinding-targets " $EthIIIf(11) "
...
stc::config $StreamBlock(3) -SrcBinding-targets " $EthIIIf(11) "
stc::config $StreamBlock(3) -DstBinding-targets " $EthIIIf(12) "
...
stc::config $StreamBlock(4) -SrcBinding-targets " $EthIIIf(12) "
stc::config $StreamBlock(4) -DstBinding-targets " $EthIIIf(13) "
stc::config $StreamBlock(4) -AffiliationFrameLengthDistribution-targets " $FrameLengthDistribution(1) "
stc::config $StreamBlock(4) -AffiliationStreamBlockLoadProfile-targets " $StreamBlockLoadProfile(4) "
...
stc::config $StreamBlock(5) -SrcBinding-targets " $EthIIIf(13) "
stc::config $StreamBlock(5) -DstBinding-targets " $EthIIIf(14) "
stc::config $StreamBlock(5) -AffiliationFrameLengthDistribution-targets " $FrameLengthDistribution(1) "
stc::config $StreamBlock(5) -AffiliationStreamBlockLoadProfile-targets " $StreamBlockLoadProfile(5) "
...
stc::config $StreamBlock(6) -SrcBinding-targets " $EthIIIf(14) "
stc::config $StreamBlock(6) -DstBinding-targets " $EthIIIf(15) "
stc::config $StreamBlock(6) -AffiliationFrameLengthDistribution-targets " $FrameLengthDistribution(1) "
stc::config $StreamBlock(6) -AffiliationStreamBlockLoadProfile-targets " $StreamBlockLoadProfile(6) "
...
stc::config $StreamBlock(7) -SrcBinding-targets " $EthIIIf(15) "
stc::config $StreamBlock(7) -DstBinding-targets " $EthIIIf(16) "
stc::config $StreamBlock(7) -AffiliationFrameLengthDistribution-targets " $FrameLengthDistribution(1) "
stc::config $StreamBlock(7) -AffiliationStreamBlockLoadProfile-targets " $StreamBlockLoadProfile(7) "
...
stc::config $StreamBlock(8) -SrcBinding-targets " $EthIIIf(16) "
stc::config $StreamBlock(8) -DstBinding-targets " $EthIIIf(9) "
stc::config $StreamBlock(8) -AffiliationFrameLengthDistribution-targets " $FrameLengthDistribution(1) "
stc::config $StreamBlock(8) -AffiliationStreamBlockLoadProfile-targets " $StreamBlockLoadProfile(8) "
stc::config $EmulatedDeviceGenParams(1) -SelectedPort-targets " $Port(1) $Port(2) $Port(3) $Port(4) $Port(5) $Port(6) $Port(7) $Port(8) "
...
stc::config $EmulatedDevice(1) -TopLevelIf-targets " $Ipv4If(9) "
stc::config $EmulatedDevice(1) -PrimaryIf-targets " $Ipv4If(9) "
stc::config $Ipv4If(9) -StackedOnEndpoint-targets " $EthIIIf(9) "
stc::config $EmulatedDevice(2) -TopLevelIf-targets " $Ipv4If(10) "
stc::config $EmulatedDevice(2) -PrimaryIf-targets " $Ipv4If(10) "
stc::config $Ipv4If(10) -StackedOnEndpoint-targets " $EthIIIf(10) "
stc::config $EmulatedDevice(3) -TopLevelIf-targets " $Ipv4If(11) "
stc::config $EmulatedDevice(3) -PrimaryIf-targets " $Ipv4If(11) "
stc::config $Ipv4If(11) -StackedOnEndpoint-targets " $EthIIIf(11) "
stc::config $EmulatedDevice(4) -TopLevelIf-targets " $Ipv4If(12) "
stc::config $EmulatedDevice(4) -PrimaryIf-targets " $Ipv4If(12) "
stc::config $Ipv4If(12) -StackedOnEndpoint-targets " $EthIIIf(12) "
stc::config $EmulatedDevice(5) -TopLevelIf-targets " $Ipv4If(13) "
stc::config $EmulatedDevice(5) -PrimaryIf-targets " $Ipv4If(13) "
stc::config $Ipv4If(13) -StackedOnEndpoint-targets " $EthIIIf(13) "
stc::config $EmulatedDevice(6) -TopLevelIf-targets " $Ipv4If(14) "
stc::config $EmulatedDevice(6) -PrimaryIf-targets " $Ipv4If(14) "
stc::config $Ipv4If(14) -StackedOnEndpoint-targets " $EthIIIf(14) "
stc::config $EmulatedDevice(7) -TopLevelIf-targets " $Ipv4If(15) "
stc::config $EmulatedDevice(7) -PrimaryIf-targets " $Ipv4If(15) "
stc::config $Ipv4If(15) -StackedOnEndpoint-targets " $EthIIIf(15) "
stc::config $EmulatedDevice(8) -TopLevelIf-targets " $Ipv4If(16) "
stc::config $EmulatedDevice(8) -PrimaryIf-targets " $Ipv4If(16) "
stc::config $Ipv4If(16) -StackedOnEndpoint-targets " $EthIIIf(16) "
stc::config $ResultQuery(3) -ResultFilters-targets " $RxPortResultFilter(3) "
...
stc::config $RxPortResultFilter(3) -RxPortList ""
...
stc::config $VerifyResultsValueCondition(1) -ResultQuery "$ResultQuery(6)"
...
stc::config $GeneratorStartCommand(1) -GeneratorList "$Generator(1) $Generator(2) $Generator(3) $Generator(4) $Generator(5) $Generator(6) $Generator(7) $Generator(8)"
stc::config $ResultQuery(6) -ResultRootList "$Project(1)"
stc::config $ResultQuery(6) -PropertyHandleArray ""
stc::config $L2LearningStartCommand(1) -HandleList "$Port(1) $Port(2) $Port(3) $Port(4) $Port(5) $Port(6) $Port(7) $Port(8)"
stc::config $SequencerIfCommand(1) -CommandList ""
stc::config $ResultsClearAllCommand(1) -PortList "$Project(1)"
stc::config $GeneratorWaitForStopCommand(1) -GeneratorList "$Generator(1) $Generator(2) $Generator(3) $Generator(4) $Generator(5) $Generator(6) $Generator(7) $Generator(8)"
...
proc run {} {
    # Subscribe to results for result query 8Port_100M_Burst-0003-rxstreamsummaryresults
