...
# 6Port_1000M_Burst_logic.tcl script. After sourcing the logic script,
...
source [ file normalize [ file join [ file dirname [ info script ] ] {6Port_1000M_Burst_logic.tcl} ] ]


init [ file normalize [ file join [ file dirname [ info script ] ] {6Port_1000M_Burst_log.tcl} ] ]
#config [list "//10.11.1.3/3/1" "//10.11.1.3/3/2" "//10.11.1.3/3/3" "//10.11.1.3/3/4" "//10.11.1.3/3/5" "//10.11.1.3/3/6" ]
